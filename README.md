...
```powershell
[System.Environment]::SetEnvironmentVariable("MINIMAX_API_KEY", "你的真实 API Key", "User")
```
...
- 作者: leno
- GitHub: [@2836240651](https://github.com/2836240651)
- 项目链接: [hello-claw](https://github.com/2836240651/hello-claw)
